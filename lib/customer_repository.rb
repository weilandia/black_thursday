...
class CustomerRepository
  ...
  def find_all_by_first_name(first_name)
    @all_customers.select {|search| search.first_name.downcase.include? first_name.downcase}
  end

  def find_all_by_last_name(last_name)
    @all_customers.select {|search| search.last_name.downcase.include? last_name.downcase}
  end
end
