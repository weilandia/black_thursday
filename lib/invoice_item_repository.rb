...
class InvoiceItemRepositoryTest < Minitest::Test
  def test_invoice_items_repo_can_list_all_invoice_items
    invoice_items = CSV.open "./test_data/invoice_items_test.csv", headers: true, header_converters: :symbol
  ...
  def test_invoice_items_repo_can_find_all_by_item_id
    ...
    assert_equal 8, invoice_items_repo.find_all_by_item_id(1).length
  end
